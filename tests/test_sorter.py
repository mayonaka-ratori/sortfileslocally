...
def test_sorter_safety():
    ...
    # Setup Dirs with tempfile
    base_dir = tempfile.mkdtemp()
    src_dir = os.path.join(base_dir, "test_sort_src")
    dst_dir = os.path.join(base_dir, "test_sort_dst")
    log_dir = os.path.join(base_dir, "test_sort_logs")
    ...
    dst_file = os.path.join(dst_dir, "CategoryA", "test_img.jpg")
    ...
    dst_file_move = os.path.join(dst_dir, "CategoryB", "test_img.jpg")
